...
-- This is used for reference as an example of how
-- to use the type system to maintain the height invariant
-- for a B-Tree implementation of a Set.

module Data.BasicSet
  ( Vicinity
  , insert
  , union
  , fromList
